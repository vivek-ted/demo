1. Set path for PHP to access it globally by "SET PATH=%path%;c:\dev\tools\server\php" NOTE: setting up the path is validate until the window is closed.Raguramlady::peter
